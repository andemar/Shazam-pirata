...
public class ProcesamientoDeImagenes {
	...
	public void prosesamientoImagen()
	{
		...
		imagenProcesada = imagenRecortada;
	}
	...
	private int calcularUl(BufferedImage imagen){
	...
	private int calcularBl(BufferedImage imagen){
	...
	public BufferedImage getImgenProcesada(){
